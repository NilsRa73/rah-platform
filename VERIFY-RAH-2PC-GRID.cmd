...
cd /d "%~dp0"
title RAH Raven 2-PC Grid v1.3.0 - Verify

echo ============================================================
echo        RAH RAVEN 2-PC GRID v1.3.0 - SELF TEST
echo ============================================================
...
echo.
echo ============================================================
echo RAH RAVEN 2-PC GRID v1.3.0: PASS
...
echo.
echo ============================================================
echo RAH RAVEN 2-PC GRID v1.3.0: FAIL
echo ============================================================
pause
exit /b 1
