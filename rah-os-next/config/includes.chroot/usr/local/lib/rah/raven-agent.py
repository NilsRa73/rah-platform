...
<body><main>
<div class="brand">RAH OS RAVEN v0.7 GOLD SHELL • RAVEN AGENT v0.2</div>
<h1>Raven Command Center</h1>
<section class="hero">
<h2 class="PASS">● Raven Core online</h2>
<p>Local service: <code>127.0.0.1:18765</code>. v0.7 is the <b>Gold Shell development candidate</b>: choose a boot profile, use the GUI, and validate hardware without opening Terminal.</p>
...
<p class="muted">This build is still read-only at the Raven system layer. No authenticated privilege broker or destructive Raven system action is enabled in RAH OS v0.7. Raven Agent remains v0.2 and loopback-only.</p>
</section>
<script>
