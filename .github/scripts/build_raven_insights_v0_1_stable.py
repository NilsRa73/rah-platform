...
frozen=[
 ...
 'RAH-RAVEN-VISION-CORE.html','RAH-RAVEN-VISION-VERSION.json','RAH-RAVEN-COUNCIL.html','RAH-RAVEN-COUNCIL-VERSION.json','RAH-RAVEN-AGENT-RUNNER.html','RAH-RAVEN-AGENT-RUNNER-VERSION.json','RAH-RAVEN-MEMORY-SYNC.html','RAH-RAVEN-MEMORY-SYNC-VERSION.json','RAH-RAVEN-MISSION-CONTROL.html','RAH-RAVEN-MISSION-CONTROL-VERSION.json','RAH-RAVEN-PROJECT-FOCUS.html','RAH-RAVEN-PROJECT-FOCUS-VERSION.json','RAH-RAVEN-CORE-DEMO.html','RAH-RAVEN-CORE-VERSION.json','RAH-RAVEN-NOW.html','RAH-RAVEN-NOW-VERSION.json','RAH-RAVEN-START.html','RAH-RAVEN-STUDIO-VERSION.json','raven-checkpoint-policy.js'
]
