...
$Log = Join-Path $LogDir ('RAH_WORLD_MEDIA_v110_' + (Get-Date -Format 'yyyyMMdd_HHmmss') + '.log')
...
Log '============================================================'
Log ' RAH WORLD MEDIA v11.0 RAVEN BROADCAST DECK - PRECHECK'
Log '============================================================'
Log ("Package: " + $Root)
$py = Find-Python
if(-not $py){
...
if($SelfTest){
  ...
  Log '============================================================'
  Log ' RAH WORLD MEDIA v11.0 SELFTEST: PASS (warnings may remain)'
  Log '============================================================'
  Read-Host 'Press Enter'
  exit 0
}

Log 'POSTCHECK: starting RAH World Media v11.0 RAVEN BROADCAST DECK...'
