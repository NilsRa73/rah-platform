...
_spec=importlib.util.spec_from_file_location('rah_node_agent_rollback_v08',BASE_PATH)
if _spec is None or _spec.loader is None:raise RuntimeError('Unable to load Node Agent 0.8 rollback runtime')
...
# Patch only this Stable v0.9 module instance. Node Agent 0.8 remains the immutable rollback runtime.
