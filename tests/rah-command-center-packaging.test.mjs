...
test('v0.3.3 remains an offline-first bugfix candidate with frozen runtime', () => {
...
test('manual network updater stays explicit and fixed to the Command Center package allowlist', () => {
