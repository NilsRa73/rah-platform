...
assert.match(html,/RAH Raven Now v2\.16/);
assert.match(html,/v2\.16 · READ ONLY/);
...
console.log('Raven Now v2.16 shared Context Snapshot and read-only navigation passed.');
