...
assert.match(html,/RAH Raven Now v2\.14/);
assert.match(html,/v2\.14 · READ ONLY/);
...
console.log('Raven Now v2.14 shared Context Snapshot and read-only navigation passed.');
