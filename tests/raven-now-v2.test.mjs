...
assert.match(html,/RAH Raven Now v2\.13/);
assert.match(html,/v2\.13 · READ ONLY/);
...
console.log('Raven Now v2.13 shared Context Snapshot and read-only navigation passed.');
