...
assert.match(html,/RAH Raven Now v2\.9/);
assert.match(html,/v2\.9 · READ ONLY/);
...
assert.match(html,/function updateContinue\(s,m,block,activeIndex,active,relation\)/);
...
console.log('Raven Now v2.9 shared project-mission relation and read-only navigation passed.');
