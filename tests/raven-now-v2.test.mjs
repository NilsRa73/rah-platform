...
assert.match(html,/v2\.1 · READ ONLY/);
...
// Dashboard is strictly read-only. Project clicks only navigate to Project Focus.
...
console.log('Raven Now v2.1 clickable read-only project navigation passed.');
