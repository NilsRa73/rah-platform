...
assert.match(html,/RAH Raven Now v2\.15/);
assert.match(html,/v2\.15 · READ ONLY/);
...
console.log('Raven Now v2.15 shared Context Snapshot and read-only navigation passed.');
