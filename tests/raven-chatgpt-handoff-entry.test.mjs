...
assert.match(now,/RAH Raven Now v2\.12/);
assert.match(studio,/RAH Raven Studio v2\.3/);
...
console.log("Raven 2.0.24 exposes source-aware navigation-only ChatGPT Handoff entries in Now and Studio.");
