...
assert.match(html,/RAH Raven Mission Control v2\.7/);
assert.match(html,/v2\.7 · LOCAL FIRST/);
...
assert.match(html,/mission-control-v2\.7/);
...
assert.match(relationBody,/Checkpoint\.projectMissionRelation/);
...
console.log('Raven Mission Control v2.7 shared project-mission relation and safe mission controls passed.');
