...
"""RAH Raven Bridge + queued Job Executor + AI Fabric entrypoint.

Keeps the canonical raven_bridge module intact and layers Raven Jobs and the
local-first AI Fabric on top.
"""
