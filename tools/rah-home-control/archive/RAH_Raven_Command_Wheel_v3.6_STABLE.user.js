...
// @version      3.6.0
// @description  Black/gold RAH command wheel with local RAH Control Center, multi-monitor shortcuts and Raven commands.
// @author       RAH AI Studios
// @match        https://chatgpt.com/*
// @match        https://chat.openai.com/*
// @match        https://nilsra73.github.io/rah-platform/*
// @match        https://github.com/NilsRa73/rah-platform*
...
(() => {
    ...
    if (connectRahBackgroundTab()) return;
    ...
    function start() {
        ...
        function applySettings() {
            ...
            root.classList.toggle(
                "rah-theme",
                settings.master && settings.theme
            );
            root.classList.toggle(
                "rah-focus",
                settings.master && settings.focus
            );
            root.classList.toggle(
                "rah-lightgun",
        ...
        function resetSettings() {
            if (!window.confirm("Reset all RAH v3.5 settings?")) return;
        ...
        ui.addEventListener("click", event => {
            ...
            if (settingButton) {
                ...
                projectPanel.classList.remove("open");
                writePrompt(
                    `Continue work on the ${name} project. Review where we stopped and complete the next practical step.`,
                    true
                );
        ...
        showToast("RAH COMMAND WHEEL v3.5 ONLINE · ALT+R");
    }
